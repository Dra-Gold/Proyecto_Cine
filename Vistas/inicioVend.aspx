<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true" CodeBehind="inicioVend.aspx.cs" Inherits="Vistas.inicioVend" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
          ...
          <ul class="nav navbar-nav">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a   href="VentaVende.aspx" target="vista">Venta</a></li>
    ...
    <br />
    <br />
    <div align="center"><iframe   src="BienveVende.aspx"  name="vista" width="1050" marginwidth="0" height="700" 
