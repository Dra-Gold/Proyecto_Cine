<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true" CodeBehind="ModiFunci.aspx.cs" Inherits="Vistas.ModiFunci" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <center>
        ...
        <h1>Modificar Funcion </h1>
      </div>
    <table border="0" cellpadding="5" cellspacing="5" class="auto-style2" >
        <tr>
    <td>Nombre&nbsp; Funcion </td>
    <td class="auto-style1">
        <asp:ListBox ID="ListBox5" runat="server" DataSourceID="NomFunci" DataTextField="NombreF" DataValueField="Codigo" Rows="1"></asp:ListBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ListBox5" ErrorMessage="*" ForeColor="#990033"></asp:RequiredFieldValidator>
      </td>
  </tr>
        <tr>
    <td>Nuevo Nombre</td>
    <td class="auto-style1">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="ListBox4" ErrorMessage="*" ForeColor="#990033"></asp:RequiredFieldValidator>
      </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center" class="auto-style1">
        <asp:Button ID="Button1" runat="server" Text="Modificar Funcion" OnClick="Button1_Click" />
      </td>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CineVConnectionString %>" SelectCommand="SELECT [IdPelicula], [NombreP] FROM [Pelicula]"></asp:SqlDataSource>
         <asp:SqlDataSource ID="NomFunci" runat="server" ConnectionString="<%$ ConnectionStrings:CineVConnectionString %>" SelectCommand="SELECT [NombreF], [Codigo] FROM [Funcion]"></asp:SqlDataSource>
