<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true" CodeBehind="VentaVende.aspx.cs" Inherits="Vistas.VentaVende" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center>
        ...
        <h1>Comprar Boleto<asp:ScriptManager ID="ScriptManager1" runat="server">
         ...
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" DataKeyNames="Codigo" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Horizontal" Height="115px" AllowPaging="True" PageSize="3" Width="1030px" OnPageIndexChanging="GridView1_PageIndexChanging" EmptyDataText="No Hay Funciones" OnRowCommand="GridView1_RowCommand">
