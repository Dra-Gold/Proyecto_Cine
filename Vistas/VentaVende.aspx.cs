...
namespace Vistas
{
    public partial class VentaVende : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            foreach (string item in boletos)
            {
                ...
                try
                {
                    ...
                    string ruta = @"C:\Cine\Vistas\Venta\";

                    if (Directory.Exists(ruta))
                    {
                        FileStream fs = new FileStream(@"C:\Cine\Vistas\Venta\" + nuevacadena + ".pdf", FileMode.OpenOrCreate);
